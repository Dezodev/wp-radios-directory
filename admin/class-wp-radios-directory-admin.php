...
class Wp_Radios_Directory_Admin {
	...
	public function radios_dir_post_type() {
		...
		$labels = array(
			...
			'menu_name'             => __( 'Radios List', 'wp-radios-directory' ),
			'name_admin_bar'        => __( 'Radios List', 'wp-radios-directory' ),
	...
	public function radio_dir_taxonomy() {
		...
		$labels = array(
			'name'                       => _x( 'Types', 'Taxonomy General Name', 'wp-radios-directory' ),
			'singular_name'              => _x( 'Type', 'Taxonomy Singular Name', 'wp-radios-directory' ),
			'menu_name'                  => __( 'Type', 'wp-radios-directory' ),
			'all_items'                  => __( 'All Types', 'wp-radios-directory' ),
			'parent_item'                => __( 'Parent Type', 'wp-radios-directory' ),
			'parent_item_colon'          => __( 'Parent Type:', 'wp-radios-directory' ),
			'new_item_name'              => __( 'New Type Name', 'wp-radios-directory' ),
			'add_new_item'               => __( 'Add New Type', 'wp-radios-directory' ),
			'edit_item'                  => __( 'Edit Type', 'wp-radios-directory' ),
			'update_item'                => __( 'Update Type', 'wp-radios-directory' ),
			'view_item'                  => __( 'View Type', 'wp-radios-directory' ),
			...
			'popular_items'              => __( 'Popular Types', 'wp-radios-directory' ),
			'search_items'               => __( 'Search Types', 'wp-radios-directory' ),
			'not_found'                  => __( 'Not Found', 'wp-radios-directory' ),
			'no_terms'                   => __( 'No items', 'wp-radios-directory' ),
			'items_list'                 => __( 'Types list', 'wp-radios-directory' ),
			'items_list_navigation'      => __( 'Types list navigation', 'wp-radios-directory' ),
		);
		$rewrite = array(
			'slug'                       => 'radios-type',
			'with_front'                 => true,
